            ...
            <section className="border-b border-white/10 bg-[#111111]">
                ...
                <div className="mx-auto max-w-[110rem] px-5 py-8 sm:px-8 md:py-12 lg:px-12 xl:px-[7%]">
                    ...
                    <div className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                        ...
                        <p className="max-w-[400px] font-['Barlow'] text-[13px] leading-6 text-white/35 sm:text-right">
                    ...
                    {loading ? (
                        ...
                        <div className="flex min-h-[300px] items-center justify-center">
                            ...
                            <p className="font-['Barlow'] text-sm uppercase tracking-[0.15em] text-white/35">
                                Loading Gallery...
                            </p>
                                    ...
                                    >
                                        ...
                                        {item.image ? (
                                            ...
                                            <div className="flex h-full items-center justify-center bg-[#151515] text-white/20">
                                                ...
                                                <span className="font-['Barlow'] text-sm uppercase tracking-wider">
                                                    No Image
                                                </span>
                                        ...
                                        <div className="absolute bottom-0 left-0 w-full p-5">
                                            ...
                                            <p className="font-['Barlow'] text-[11px] font-semibold uppercase tracking-[0.15em] text-[#e85d3a]">
                                                Fitness Centers
                                            </p>

                                            <h3 className="mt-2 max-w-[400px] font-['Bebas_Neue'] text-[24px] leading-none tracking-wide text-white">
                                                {item.description ||
                                                    "Fitness Training"}
                                            </h3>
                        ...
                        <div className="border border-white/10 bg-[#151515] py-20 text-center">
                            ...
                            <p className="font-['Bebas_Neue'] text-[28px] text-white/40">
                                NO GALLERY PHOTOS YET.
                            </p>

                            <p className="mt-2 font-['Barlow'] text-sm text-white/30">
            ...
            <section>
                ...
                <div className="mx-auto max-w-[110rem] px-5 py-6 sm:px-8 md:py-8 lg:px-12 xl:px-[7%]">
                    ...
                    <div className="flex justify-center">
                        ...
                        <Link
                            to="/gallery"
                            className="group flex h-[48px] items-center justify-center gap-3 bg-[#e85d3a] px-8 font-['Barlow'] text-[13px] font-bold uppercase tracking-[0.1em] text-white transition-all duration-300 hover:bg-[#f06a49]"
                            style={{
                                clipPath:
