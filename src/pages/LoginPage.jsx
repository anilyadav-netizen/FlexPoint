...
import { loginUser, clearAuthError } from "../redux/Slicer/authSlice";
import { ArrowRight, Mail, Lock, Eye, EyeOff, Dumbbell } from "lucide-react";
                    ...
                    <div className="flex min-h-[650px] flex-col justify-center p-6 sm:p-10 md:p-12 lg:p-10 xl:p-14">
                        ...
                        <div className="mt-3">
                            ...
                            <h2 className="mt-2 font-['Bebas_Neue'] text-[38px] leading-[0.85] tracking-wide sm:text-[44px]">
                                WELCOME
                                <span className="text-[#e85d3a]"> BACK.</span>
                            </h2>
