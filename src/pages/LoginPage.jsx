...
const LoginPage = () => {
    ...
    return (
        <main className="min-h-screen w-full bg-[#0d0d0d] text-white">
            <div className="mx-auto flex w-full max-w-[1400px] items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
                <div className="mt-24 grid w-full max-w-[1050px] overflow-hidden border border-white/10 bg-[#111111] lg:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="h-[48px] w-full border border-white/10 bg-[#171717] pl-11 pr-4 font-['Barlow'] text-[13px] text-white outline-none transition-colors duration-300 placeholder:text-white/25 focus:border-[#e85d3a]/70"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="h-[48px] w-full border border-white/10 bg-[#171717] pl-11 pr-12 font-['Barlow'] text-[13px] text-white outline-none transition-colors duration-300 placeholder:text-white/25 focus:border-[#e85d3a]/70"
                                    />
